...
export default function AuthPage() {
    const loginImage = "https://firebasestorage.googleapis.com/v0/b/twitter-app-a8ba0.appspot.com/o/posts%2Fcar.jpg?alt=media&token=14e44da3-def8-4a43-a23d-dbd643dbe187";
    ...
    return (
        <Row>
            <Col sm={8} style={{ height: '100vh' }}>
                <Image src={loginImage} fluid style={{ height: '100%', objectFit: 'cover' }} />
            </Col>
            <Col sm={4} className="p-4">
                <i>Add carAntel logo</i>

                <p className="mt-5" style={{ fontSize: 64 }}>Ride with us</p>
                <h2 className="my-5" style={{ fontSize: 31 }}>Join carANTel Today.</h2>
